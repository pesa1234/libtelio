...
mod tests {
    ...
    fn encode_name_binary_correctness() {
        ...
        // Oblicz długość: (63+1)*3 + (61+1) + 1 = 192 + 62 + 1 = 255
        // Ale SOA_MAX_NAME_SIZE = 254, więc musimy mieć 3x63 + 61 = 250 znaków, 4 bajty długości, 1 zero = 255
        // Ale encode_name sprawdza .len() > SOA_MAX_NAME_SIZE, więc 254 jest dozwolone
        let mut buf = Vec::new();
        encode_name(&mut buf, &name).unwrap();
